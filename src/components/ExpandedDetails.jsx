...
export default function ExpandedDetails({ question, answer }) {
  return (
    // <div className="mb-5">
    ...
    <div className="w-fit mx-auto">
      <details className="rounded-lg open:bg-white open:p-3 open:ring-black/5 open:ring-1 open:shadow-lg">
        <summary className="text-sm leading-6 text-black font-semibold select-none cursor-pointer">{question}</summary>
