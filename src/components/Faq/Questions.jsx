...
const questions = [
    {
        ...
        answer: (
            <>
                ...
                any artist on Spotify. I created it because I love music and web
                development and I noticed a lack of good bracket-making tools of
    ...
    },
    {
        ...
        answer: (
            <ol className="list-decimal list-inside">
                ...
                <li>
                    Select an artist from the popup and a bracket will be
                    created containing the artist's most popular tracks
                </li>
            </ol>
        ),
        paths: ["/my-brackets/"],
    },
    {
        ...
        answer: (
            <>
                ...
                you're finished, click "Start Bracket" and begin picking songs
