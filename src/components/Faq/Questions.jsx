...
const questions = [
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        number of tracks and choose different seeding methods use the dropdowns
        at the top. To start picking songs to advance, click{" "}
        <span className="inline-block">
  ...
  },
  {
    ...
    answer: (
      <>
        Start selecting songs to advance to the next round! If an audio preview
        is availiable for a track, you'll see a "play" icon next to the track
        name which will play 30 seconds of the song. You can also click the
        Spotify icon in the top right to open the track in Spotify. Keep
  ...
  },
  {
    ...
    answer: (
      <>
        Click the <CornerButton autoPosition={false} /> button in the top right
        corner of a bracket card
      </>
    ),
    paths: ["/my-brackets/"],
  },
  ...
  },
  {
    ...
    answer: (
      <>
        Spotify makes it difficult to consolidate all versions of the same song
        (especially when they are titled slightly differently eg. "Remastered"
        or "Radio edit"). This application uses a custom algorithm to avoid
        showing duplicates but there are still some cases where it happens. If
        you notice this, please{" "}
        <a
